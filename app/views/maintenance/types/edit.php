        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">ویرایش نوع نگهداری</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="/maintenance/types/update/<?= $maintenanceType['id'] ?>">
                        <div class="mb-3">
                            <label for="name" class="form-label">نام نوع نگهداری <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="name" name="name" value="<?= htmlspecialchars($maintenanceType['name']) ?>" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="description" class="form-label">توضیحات</label>
                            <textarea class="form-control" id="description" name="description" rows="3"><?= htmlspecialchars($maintenanceType['description']) ?></textarea>
                        </div>
                        
                        <div class="mb-3">
                            <label for="interval_days" class="form-label">دوره زمانی (روز) <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="interval_days" name="interval_days" min="1" value="<?= $maintenanceType['interval_days'] ?>" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="checklist" class="form-label">چک‌لیست (هر مورد در یک خط)</label>
                            <textarea class="form-control" id="checklist" name="checklist" rows="5"><?= htmlspecialchars($maintenanceType['checklist']) ?></textarea>
